...
namespace SplitAndMerge
{
    ...
    class AppendFunction : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            ...
            string arg1 = currentValue.String ?? currentValue.Value.ToString();
            string arg2 = newValue.String ?? newValue.Value.ToString();
    ...
    class IndexOfFunction : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            ...
            // 4. Take either the string part if it is defined,
            // or the numerical part converted to a string otherwise.
            string basePart = currentValue.String ?? currentValue.Value.ToString();
            string search = searchValue.String ?? searchValue.Value.ToString();
